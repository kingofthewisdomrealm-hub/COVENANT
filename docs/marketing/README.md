# Marketing drafts — Covenant Builders (Phase 3)

You post; we draft. No GoDaddy Marketing add-on required.
...
- Do not invent client quotes or review text
- Prefer `covenantbuilders.org/contact` once DNS is on Vercel; until then use phone + estimating@
- License line when space allows: Florida CBC1253676
