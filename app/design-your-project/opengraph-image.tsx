...
export const alt =
	'Design your construction project online — Covenant Builders, Vero Beach'
export const size = { width: 1200, height: 630 }
export const contentType = 'image/png'

export default function DesignYourProjectOgImage() {
		...
		(
			...
			>
				<div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
					...
					>
						Answer a few questions. In about five minutes you have a written
						project brief — free, no obligation.
					</div>
				</div>
				<div
					style={{
