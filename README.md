...
- [Covenant Assistant](docs/assistant.md) — private Claude assistant at `/assistant/<secret>`: reads the CRM, proposes leads, storm check / money map / project designer as tools
